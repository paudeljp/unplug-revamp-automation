...
import { clickButtonWithContainsObj, clickButtonWithoutContainsObj } from '../common/buttonObj';
...
export function grabTextFromJsonObj(filePath, string, value) {
    return grabTextP.grabTextFromJson(filePath, string, value).then(response => {
